...
export default class HttpServer {
    ...
    private httpRequestHandler = (req: http.IncomingMessage, res: http.ServerResponse) => {
        ...
        fs.readFile(localUrl, (err, data) => {
            ...
            let mimeType = MimeTypeMap[ext];
            if (!mimeType) {
                mimeType = MimeTypeMap.text;//默认html
            }
    ...
    private httpResp(code: number, res: http.ServerResponse, content?: any) {
        res.writeHead(code, { "content-type": `${MimeTypeMap.html};charset='utf-8'` });
        res.write(content);
        res.end();
    }
    public clear() {
